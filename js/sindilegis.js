...
async function buscarClinicasSindilegis() {
    ...
    try {
        ...
        console.log("Iniciando busca da Rede Sindilegis...");
        ...
        if (idsClinicas.length > 0) {
            ...
            if (erroEspecialidades) {
                ...
                console.error(
                    "Erro ao buscar especialidades Sindilegis:",
                    erroEspecialidades
                );
        ...
        console.error(
            "Erro inesperado na busca Sindilegis:",
            erro
        );
...
function mostrarErroBuscaSindilegis(mensagem) {
        ...
        botao.addEventListener(
            ...
            async () => {
                ...
                try {
                    ...
                    await buscarClinicasSindilegis();
