                        ...
                        <tr>
                            ...
                            <td class="acoes-tabela">
                                ...
                                <button
                                    ...
                                    data-acao="editar-especialidade"

                                    data-id="${especialidade.id}"

                                    data-nome="${escaparHTML(especialidade.nome)}"
                                ...
                                <button
                                    ...
                                    data-acao="excluir-especialidade"
                        ...
                        <tr>
                            ...
                            <td class="acoes-tabela">
                                ...
                                <button
                                    ...
                                    data-acao="editar-regiao"

                                    data-id="${regiao.id}"

                                    data-nome="${escaparHTML(regiao.nome)}"
                        ...
                        <tr>
                            ...
                            <td class="acoes-tabela">
                                ...
                                <button
                                    ...
                                    data-acao="editar-estado"

                                    data-id="${estado.id}"

                                    data-nome="${escaparHTML(estado.nome)}"
                        ...
                        <tr>
                            ...
                            <td class="acoes-tabela">
                                ...
                                <button
                                    ...
                                    data-acao="editar-cidade"

                                    data-id="${cidade.id}"

                                    data-nome="${escaparHTML(cidade.nome)}"
...
// AÇÕES SEGURAS DOS BOTÕES DAS TABELAS
...
async function abrirModalClinica(
    ...
    if (!id) {
        ...
        // GARANTIR CIDADE E BAIRRO LIMPOS
