...
async function excluirRegiao(id) {
    ...
    if (error) {
        ...
        alert(
            "Erro ao excluir região. Verifique se existem estados vinculados."
        );
...
async function excluirEstado(id) {
    ...
    if (error) {
        ...
        alert(
            "Erro ao excluir estado. Verifique se existem cidades vinculadas."
        );
